 ...
 * @author dylan
 */
public class EditarMascota extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        editarMascotas = new javax.swing.JButton();
        ...
        jLabel2.setText("Editar Mascota");
        ...
        editarMascotas.setBackground(new java.awt.Color(242, 82, 100));
        editarMascotas.setFont(new java.awt.Font("Liberation Sans", 1, 15)); // NOI18N
        editarMascotas.setForeground(new java.awt.Color(235, 236, 238));
        editarMascotas.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/informe-medico.png"))); // NOI18N
        editarMascotas.setText("Editar Mascota");
        editarMascotas.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(4, 76, 92)));
        editarMascotas.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                editarMascotasActionPerformed(evt);
            }
        });
        getContentPane().add(editarMascotas, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 480, 160, 40));
        ...
        cmbEspecie.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-", "Perro", "Gato", "Conejo", "Pajaro", "Pez", "Reptil", "Roedor", "Huron" }));
    ...
    private void cargarDatosID(int id)
    {
        conect = new Conexion();
        ...
        if (masco != null) 
        {
            ...
            cmbSexo.setSelectedItem(masco.getSexo());
            cmbEspecie.setSelectedItem(masco.getEspecie());
            txtEdad.setText(String.valueOf(masco.getEdad()));
            cmbColor.setSelectedItem(masco.getColor());
            observaciones.setText(masco.getObservaciones());
            txtPeso.setText(String.valueOf(masco.getPeso()));
            txtRaza.setText(masco.getRaza());
            cmbID.setSelectedItem(masco.getId_duenio());
            String nombreDuenio = conect.obtenerNombreDuenioPorID(masco.getId_duenio());
            NombreDuenios.setText(nombreDuenio);
            if (masco.getSexo().equals("Macho")) 
            {
                cmbSexo.setSelectedIndex(1);  
            } 
            else if (masco.getSexo().equals("Hembra"))
            {
    ...
    private void editarMascotasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_editarMascotasActionPerformed
        ...
        String obvservacion = observaciones.getText();
        String color = cmbColor.getSelectedItem().toString();
        int id_duenio = Integer.parseInt(cmbID.getSelectedItem().toString());
        ...
        masco.setSexo(sexo);
        masco.setObservaciones(obvservacion);
        masco.setColor(color);
        masco.setId_mascota(id);
        masco.setId_duenio(id_duenio);
        
        conect.actualizarMascota(masco);
        val.mostrarMensaje("Se actualizaron los datos correctamente!", "Info", "Se edito una mascota");
        limpiar();
        this.dispose();
    }//GEN-LAST:event_editarMascotasActionPerformed
    ...
    private javax.swing.JButton editarMascotas;
